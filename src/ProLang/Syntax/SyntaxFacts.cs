...
internal static partial class SyntaxFacts
{
    ...
    {
        { SyntaxKind.StarToken, 9 },
        { SyntaxKind.SlashToken, 9 },
        { SyntaxKind.PercentageToken, 9 },
        { SyntaxKind.PlusToken, 8 },
        { SyntaxKind.MinusToken, 8 },
        { SyntaxKind.LessThanLessThanToken, 7 },
        { SyntaxKind.GreaterThanGreaterThanToken, 7 },
        { SyntaxKind.LessThanToken, 6 },
        { SyntaxKind.LessThanEqualToken, 6 },
        { SyntaxKind.GreaterThanToken, 6 },
        { SyntaxKind.GreaterThanEqualToken, 6 },
