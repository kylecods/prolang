...
internal static class TestCorpus
{
    ...
    [
        ...
        new("examples/19-args/args-demo.prl", CorpusKind.Runnable),
        ...
        new("tests/language/char-literals.prl", CorpusKind.Runnable),
        ...
        new("tests/language/globals/globals.prl", CorpusKind.Runnable),
        new("tests/language/globals/globals-module.prl", CorpusKind.CompileOnly,
            "Library — declares a global imported by globals.prl; exercised by it."),
        ...
        new("tests/std/test_char.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/std/run_tests.prl."),
        ...
        new("tests/std/test_widget.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/std/run_tests.prl."),
        new("tests/std/test_box.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/std/run_tests.prl."),
        ...
        new("tests/language/compiler/test-else-if.prl", CorpusKind.Runnable),
        ...
        new("tests/language/lexer/test-lexer-digits.prl", CorpusKind.Runnable),
        new("tests/language/generics/single_parameter.prl", CorpusKind.Runnable),
        new("tests/language/generics/multiple_parameters.prl", CorpusKind.Runnable),
        new("tests/language/string-methods/test-string-methods.prl", CorpusKind.Runnable),
        new("tests/language/string-methods/test-string-methods-build.prl", CorpusKind.Runnable),
        new("tests/language/string-methods/test-string-methods-compiler.prl", CorpusKind.Runnable),
        new("tests/language/string-methods/phase-b-string-methods.prl", CorpusKind.Runnable),
        ...
        new("tests/language/entry-point/global-statements-error.prl", CorpusKind.KnownBroken,
            "Negative test by design: asserts top-level statements outside any function are "
            + "rejected. The `global` keyword is the supported way to declare file-scope state; "
            + "bare top-level statements remain an error."),
