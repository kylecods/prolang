...
internal static class TestCorpus
{
    ...
    [
        ...
        new("examples/16-pixel-editor/raster.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        new("examples/16-pixel-editor/shape.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        ...
        new("examples/16-pixel-editor/tools.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        new("examples/16-pixel-editor/theme.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        new("examples/16-pixel-editor/icons.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        new("examples/16-pixel-editor/layout.prl", CorpusKind.CompileOnly,
            "Library — pixel editor module; exercised by tests/run_tests.prl."),
        ...
        new("examples/16-pixel-editor/tests/test_tools.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/run_tests.prl."),
        new("examples/16-pixel-editor/tests/test_theme.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/run_tests.prl."),
        new("examples/16-pixel-editor/tests/test_icons.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/run_tests.prl."),
        new("examples/16-pixel-editor/tests/test_shape.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/run_tests.prl."),
        new("examples/16-pixel-editor/tests/test_layout.prl", CorpusKind.CompileOnly,
            "Library — test cases; run by tests/run_tests.prl."),
